...
4. Ajouter l'origine autorisée `https://crm.osito-solution.com`.
5. Ajouter exactement l'URI de redirection `https://crm.osito-solution.com/auth/google/callback`.
...
Adresse autorisée en production : `boubacar@osito-solution.com`.
